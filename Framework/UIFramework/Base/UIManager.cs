...
//		this.SendEvent(GameEvent.UIEvent.EVENT_UI_SHOWUI, GlobalConst.UINAME_LOGINMANAGER);
	...
	void OnEnable ()
	{
		RegistEvent(GameEvent.UIEvent.EVENT_UI_SHOWUI, OnHandleShowUI);
		RegistEvent(GameEvent.UIEvent.EVENT_UI_HIDEUI, OnHandleHideUI);
	...
	void OnDisable ()
	{
		UnRegistEvent(GameEvent.UIEvent.EVENT_UI_SHOWUI, OnHandleShowUI);
		UnRegistEvent(GameEvent.UIEvent.EVENT_UI_HIDEUI, OnHandleHideUI);
	...
	object OnHandleShowUI (object pSender)
	{
		...
		{
			this.SendEvent(GameEvent.SysEvent.EVENT_WEB_ERROR, "UnityException" + ex);
		}		
