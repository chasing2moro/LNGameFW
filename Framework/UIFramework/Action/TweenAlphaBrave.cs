...
[AddComponentMenu("NGUI/Tween/AlphaBrave")]
public class TweenAlphaBrave : UITweenerBrave
{
	...
	static public TweenAlphaBrave Begin (GameObject go, float duration, float alpha)
	{
		TweenAlphaBrave comp = UITweenerBrave.Begin<TweenAlphaBrave>(go, duration);
