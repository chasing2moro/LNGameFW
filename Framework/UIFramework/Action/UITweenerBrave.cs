...
public abstract class UITweenerBrave : IgnoreTimeScale
{
	public enum Method
	{
		Linear,
	...
	public delegate void OnFinished (UITweenerBrave tween);
	...
	static public T Begin<T> (GameObject go, float duration) where T : UITweenerBrave
	{
